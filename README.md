...
1.  First, ensure all necessary dependencies are installed on your system. For Arch Linux, you can install many of them with:
    ```bash
    yay -S hyprland polkit-kde-agent waybar rofi swaync hyprlock wlogout hyprpaper kitty nautilus btop fastfetch starship grim slurp swappy jq pavucontrol playerctl brightnessctl networkmanager-applet ttf-jetbrains-mono-nerd bluez bluez-utils blueman
    ```
